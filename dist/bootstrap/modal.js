...
(function (factory) {
    ...
    const event_handler_1 = require("bootstrap/js/src/dom/event-handler");
    const manipulator_1 = require("bootstrap/js/src/dom/manipulator");
    const selector_engine_1 = require("bootstrap/js/src/dom/selector-engine");
    const scrollbar_1 = require("bootstrap/js/src/util/scrollbar");
    const base_component_1 = require("bootstrap/js/src/base-component");
    const backdrop_1 = require("bootstrap/js/src/util/backdrop");
    const focustrap_1 = require("bootstrap/js/src/util/focustrap");
    /**
     * ------------------------------------------------------------------------
     * Constants
     * ------------------------------------------------------------------------
    ...
    class Modal extends base_component_1.default {
        ...
        dispose() {
            [window, this._dialog]
                .forEach(htmlElement => event_handler_1.default.off(htmlElement, EVENT_KEY));
