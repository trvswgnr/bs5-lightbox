...
class Lightbox {
  ...
  getGalleryItems() {
    ...
    const gallery = galleryTarget ? [...new Set(Array.from(document.querySelectorAll("[data-gallery=\"".concat(galleryTarget, "\"]")), v => "".concat(v.dataset.type && v.dataset.type !== 'image' ? v.dataset.type : '').concat(this.getSrc(v))))] : [this.src];
    return gallery;
  }
  ...
  createCarousel() {
    ...
    if (this.carouselOptions.keyboard === true) {
      document.addEventListener('keydown', e => {
        ...
        if (e.code === 'ArrowLeft') {
          (_a = document.getElementById("#lightboxCarousel-".concat(this.hash, "-prev"))) === null || _a === void 0 ? void 0 : _a.click();
          return false;
        }

        if (e.code === 'ArrowRight') {
          (_b = document.getElementById("#lightboxCarousel-".concat(this.hash, "-next"))) === null || _b === void 0 ? void 0 : _b.click();
          return false;
        }
      });
    }
